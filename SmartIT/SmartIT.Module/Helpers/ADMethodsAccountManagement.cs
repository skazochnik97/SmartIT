...
namespace SmartIT.Module.Authentification
{
    ...
    public class ADMethodsAccountManagement
    {
        ...
        public ADMethodsAccountManagement(string domain,string rootOU,string serviceUser,string servicePass)
        {
            this.sDomain = domain;
            this.sDefaultRootOU = rootOU;
            this.sDefaultOU = rootOU;
            this.sServiceUser = serviceUser;
            this.sServicePassword = servicePass;
        }
        ...
        public bool IsUserGroupMember(string sUserName, string sGroupName)
        {
            UserPrincipal oUserPrincipal = GetUser(sUserName);
            GroupPrincipal oGroupPrincipal = GetGroup(sGroupName);
          //  oGroupPrincipal.GetMembers
            if (oUserPrincipal != null && oGroupPrincipal != null)
            {
                return oGroupPrincipal.GetMembers(true).Contains(oUserPrincipal);//oGroupPrincipal.Members.Contains(oUserPrincipal);
            }
            else
            {
                return false;
        ...
        /*
        public List<Principal> getAuthorizationGroups(UserPrincipal user)
        {
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        public List<Principal> GetGroups(UserPrincipal user)
        {
            DirectorySearcher search = new DirectorySearcher(this);
        ...
        */
        ...
        public PrincipalContext GetPrincipalContext()
        {
            PrincipalContext oPrincipalContext = new PrincipalContext
               (ContextType.Domain, sDomain, sDefaultOU, ContextOptions.SimpleBind/*|ContextOptions.Negotiate*/,
